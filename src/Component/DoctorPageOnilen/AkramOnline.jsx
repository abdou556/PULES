...
export default function AkramOnline() {
  ...
  return <>
    <div className="container">
      ...
      <div className="doctor-info">
        <img src="akram.jpg" alt="Doctor photo" />
    ...
    <Link to='/PaymentOnline'>
        <button className='btn btn-outline-danger mt-3 d-grid gap-2 col-6 mx-auto my-3' >to Pay</button>
      </Link>
    </div>
  </>
}
